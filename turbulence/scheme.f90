...
implicit none
   ...
   double precision, intent(in) , dimension(6) ::wl,wr
   double precision, intent(out), dimension(6) ::flux


   double precision ul,vl,rhol,gmmal,unl,phil(6),al,Ml,betal,pl,kl,epl
   double precision ur,vr,rhor,gmmar,unr,phir(6),ar,Mr,betar,pr,kr,epr

   double precision N(6)
...
!double precision rhol, rhor, ul, ur, vl, vr, pl, pr, El, Er, Hl, Hr
...
!double precision, dimension(4,-1:ni  ,-1:nj  ) :: w_left, w_right, w_down, w_up
...
integer i,j
double precision temp0, temp1, temp2, temp3, temp4, temp5, temp6, temp7, temp8, temp9
double precision, dimension(6,-1:ni  ,-1:nj  ) :: w_left, w_right, w_down, w_up
