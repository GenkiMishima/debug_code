...
!            end if
!         end do
!         lambda1=2d0/max(5d0*abs(DlogT),abs(lambda1),2d0)
...
!            end if
!         end do
!         lambda1=2d0/max(5d0*abs(DlogT),5d0*abs(Dlogsn),abs(lambda1),2d0)
!         omega_var=min(1d0,min(lambda1,lambda2))
!
!         !set new sn
...
!            end if
!         end do
!         lambda1=2d0/max(5d0*abs(Dlogsn),abs(lambda1),2d0)
!         omega_var=min(1d0,min(lambda1,lambda2))
!
!         !set new sn
!         b0(ne+1)=b0(ne+1)*exp(omega_var*Dlogsn)
